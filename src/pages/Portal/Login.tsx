...
const PortalLoginPage: React.FC = () => {
    ...
    return (
        <>
            ...
            <title>Student Portal Login | Bethel School of Fashion and Design</title>

            <meta
                name="description"
                content="Access the Bethel School of Fashion and Design student portal. Log in to view your dashboard, fees, profile details, and admission information."
            />

            <meta
                name="keywords"
                content="Bethel Fashion School Portal, Student Portal Login, Bethel School Login, Fashion School Portal Ghana"
            />
