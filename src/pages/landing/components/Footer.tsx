import crownImg from "../../../../assets/images/crownine.png";
          ...
          <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
              <div className="flex items-center space-x-2">
                <img className="h-8 auto " src={crownImg} alt="" />
              ...
              <p className="text-base leading-relaxed text-slate-100 mt-7">
                Bethel Fashion School is your one stop place for learning
                anything fashion related. Join us lets help you build a career
                in fashion
              </p>
            ...
            <div>
              <p className="flex items-center text-sm font-semibold tracking-widest text-gray-200 uppercase">
                Locate Us <IoLocationOutline className="ml-1 text-base" />
              </p>
              ...
              <form action="#" method="POST" className="mt-6">
                <div>
                  ...
                  <input
                    ...
                    className="block w-full p-4 placeholder-gray-500 transition-all border border-gray-200 rounded-md bg-3hite dur2tion-200 text-slate-100 focus:outline-none focus:border-blue-600 caret-blue-600"
                  />
                </div>
