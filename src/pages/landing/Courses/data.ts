...
export const coursesData: CourseProps[] = [
    {
        ...
        features: [
            ...
            "Fabric and color theory workshops",
    ...
    },
    {
        ...
        level: "Beginner to Intermediate",
        features: [
            "Comprehensive event management training",
            "Floral and venue decoration techniques",
            "Vendor and budget coordination",
            "Real-world event project experience"
        ],
    },
    {
        ...
        level: "Beginner to Intermediate",
        features: [
            "Hat-making and embellishment techniques",
            "Material and design experimentation",
            "Accessory finishing and detailing",
    ...
    },
    {
        ...
        features: [
            ...
            "Proportion and anatomy training",
    ...
    },
    {
        ...
        level: "Beginner To Intermediate",
        features: [
            "Runway and photo shoot techniques",
            "Posture and confidence training",
    ...
    },
    {
        ...
        level: "Beginner to Intermediate",
        features: [
            "Professional makeup artistry techniques",
            "Bridal and editorial looks",
            "Skin tone and color blending mastery",
            "Practical product application sessions"
        ],
    },
];
