...
import students from "@/assets/images/bfs-students.jpg";
        ...
        <div className="relative min-h-screen font-poppins bg-black text-white overflow-hidden">
            ...
            <nav className="relative z-20 flex items-center justify-between px-6 sm:px-8 py-6">
                <div className="flex items-center space-x-3">
                    <div className="w-10 h-10 bg-linear-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center shadow-lg">
                        <Sparkles className="w-5 h-5 text-white" />
                    </div>
                    <span className="text-xl sm:text-2xl font-bold tracking-tight text-white">ÉLÉGANCE</span>
                </div>
                <div className="hidden md:flex items-center space-x-8">
                    <a href="#" className="text-gray-200 hover:text-white transition-colors duration-200 font-medium">Programs</a>
                    <a href="#" className="text-gray-200 hover:text-white transition-colors duration-200 font-medium">About</a>
                    <a href="#" className="text-gray-200 hover:text-white transition-colors duration-200 font-medium">Portfolio</a>
                    <a href="#" className="text-gray-200 hover:text-white transition-colors duration-200 font-medium">Contact</a>
                </div>
                <button className="px-5 py-2.5 bg-linear-to-r from-blue-600 to-blue-700 text-white font-semibold rounded-full hover:from-blue-500 hover:to-blue-600 transition-all duration-200 shadow-lg">
                    Apply Now
                </button>
            </nav>
