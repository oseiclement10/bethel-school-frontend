...
const FashionSchoolHero: React.FC = () => {
    ...
    const stats = [
        ...
        { icon: Users, value: '1K+', label: 'Alumni Network' },
    ...
    return (
        <div className="relative min-h-screen font-poppins bg-black text-white overflow-hidden">
            ...
            {/* Hero Content */}
            <div className="relative z-10 max-w-7xl lg:max-w-[90%]  mx-auto px-5 md:px-8 pt-4 md:pt-14 pb-16 md:pb-32">
               
                    <FadeUpStagger key={currentSlide} className="max-w-3xl">
                        <div className="inline-block px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full mb-3 md:mb-6">
                        ...
                        <div className="flex flex-wrap gap-3 sm:gap-4 mb-12 sm:mb-16">
                            <Link to="/apply" className="group px-6 sm:px-8 py-3 sm:py-4 bg-linear-to-r from-blue-600 to-blue-700 text-white font-semibold rounded-full hover:from-blue-500 hover:to-blue-600 transition-all duration-200 flex items-center space-x-2 shadow-lg">
                                <span>Apply Now</span>
