...
const PrimaryButton = ({
    ...
    const stying = clsx(`rounded-sm cursor-pointer flex items-center justify-center transition-smooth text-base shadow-sm bg-primary px-4 py-2 text-white ${className}`, {
